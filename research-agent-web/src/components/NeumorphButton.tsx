  ...
  return (
    <div
      className={cn(
        ...
        "bg-neutral-50 border-neutral-200 after:border-neutral-100 after:border-t-[2px] after:border-b-[2px] after:border-b-neutral-300 dark:bg-[#0f0f0f] dark:border-white/10 dark:after:border-[#1a1a1a] dark:after:border-b-black",
